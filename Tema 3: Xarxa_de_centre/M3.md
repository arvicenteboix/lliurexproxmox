...
En aquesta unitat configurarem un esquema de xarxa model amb dos *switchs* a mena d’exemple. Coneixent com es configuren dos *switchs*, configurar-ne'n més es fa de manera similar. Però abans anem a veure un poc de terminologia i tecnologia que anem a utilitzar.
