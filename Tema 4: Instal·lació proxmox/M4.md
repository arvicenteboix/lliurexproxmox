...
* Les IP utilitzades no corresponen amb les indicades al que recomana el SAI. És la tasca que se vos manarà!
...
::: warning
**Contrasenya**: Hem de respectar la política de contrasenyes, amb majúscula, minúscula i caràcter especial. El teclat està configurat per defecte en anglès.
:::
...
:::warning
El port 16993 dóna problemes, si no teniu el firmware de l'AMT actualitzat és possible que no vos deixe utilitzar el port 16993.
:::
